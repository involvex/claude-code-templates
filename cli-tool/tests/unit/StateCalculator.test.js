...
describe("StateCalculator", () => {
  ...
  describe("determineConversationStatus", () => {
    it('should return "active" for recent messages with user input', () => {
      ...
      const status = stateCalculator.determineConversationStatus(
        messages,
        lastModified,
      );
    ...
    it("should handle null/undefined inputs gracefully", () => {
      expect(
        stateCalculator.determineConversationStatus(null, new Date()),
      ).toBe("idle");
      expect(stateCalculator.determineConversationStatus([], null)).toBe(
        "idle",
      );
    });
  });
  ...
  describe("quickStateCalculation", () => {
    ...
    it("should update status when running process matches conversation", () => {
      ...
      const result = stateCalculator.quickStateCalculation(
        mockConversation,
        runningProcesses,
      );
