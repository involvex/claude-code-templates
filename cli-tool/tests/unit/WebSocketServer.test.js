...
describe("WebSocketServer", () => {
  ...
  describe("initialize", () => {
    ...
    it("should handle initialization errors", async () => {
      ...
      await expect(webSocketServer.initialize()).rejects.toThrow(
  ...
  describe("handleClientMessage", () => {
    ...
    it("should handle subscribe message", () => {
      ...
      webSocketServer.handleClientMessage(
        clientId,
        Buffer.from(subscribeMessage),
      );
    ...
    it("should handle unsubscribe message", () => {
      ...
      webSocketServer.handleClientMessage(
        clientId,
        Buffer.from(unsubscribeMessage),
      );
  ...
  describe("notification methods", () => {
    ...
    it("should notify conversation state change", () => {
      webSocketServer.notifyConversationStateChange("conv_123", "active", {
        project: "test",
      });
