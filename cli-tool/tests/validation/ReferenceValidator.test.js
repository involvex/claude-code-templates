...
Visit https://docs.example.com for documentation.`,
  ...
  describe("URL Extraction", () => {
    it("should extract markdown links", () => {
      const content =
        "[Example](https://example.com) and [Another](https://test.com)";
    ...
    it("should extract plain URLs", () => {
      const content =
        "Visit https://example.com and https://test.com for more.";
      const urls = validator.extractUrls(content);
    ...
    it("should not duplicate URLs from markdown and plain text", () => {
      const content =
        "[Link](https://example.com) and also https://example.com";
      const urls = validator.extractUrls(content);
  ...
  describe("Protocol Validation", () => {
    ...
    it("should error on data: protocol", async () => {
      const component = {
        content:
          'https://example.com and also data:text/html,<script>alert("XSS")</script>',
        path: "dangerous.md",
      };
