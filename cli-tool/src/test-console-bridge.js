...
async function testConsoleBridge() {
  ...
  console.log(
    chalk.gray(
      "This will monitor running Claude Code processes and enable web-based interaction",
    ),
  );
  console.log("");
  ...
  try {
    ...
    console.log(
      chalk.cyan("🌐 Web interface should connect to this WebSocket"),
    );
    console.log("");
    ...
    console.log(
      "  3. The console interaction panel should appear when Claude Code prompts are detected",
    );
