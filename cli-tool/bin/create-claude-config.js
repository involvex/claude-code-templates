...
program
  ...
  .option(
    "--dashboard",
    "launch unified dashboard with all tools (default: analytics view)",
  )
  ...
  .option(
    "--hooks",
    "launch Hooks Dashboard to view and manage automation hooks",
  )
  ...
  .action(async (options) => {
    try {
      ...
      const isQuietCommand =
        options.listAgents || options.removeAgent || options.updateAgent;
