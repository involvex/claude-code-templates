      ...
      agents: [
        {
          ...
          type: 'agent',
          content:
            'AI-powered code reviewer that analyzes your code for best practices, security issues, and optimization opportunities.',
        },
        {
          ...
          type: 'agent',
          content:
            'Generates comprehensive documentation for your codebase, including API docs, README files, and inline comments.',
        },
        {
          name: 'bug-hunter',
          ...
          type: 'agent',
          content:
            'Specialized in finding and fixing bugs through systematic code analysis and testing.',
        },
        {
          ...
          type: 'agent',
          content:
            'Performs security audits on your code to identify vulnerabilities and security best practices.',
        },
        {
          ...
          type: 'agent',
          content:
            'Analyzes and optimizes code performance, identifying bottlenecks and suggesting improvements.',
        },
      ],
      commands: [
        {
          ...
          type: 'command',
          content:
            'Sets up Git repository with best practices, including .gitignore, hooks, and workflow configurations.',
        },
        {
          name: 'project-init',
          ...
          type: 'command',
          content:
            'Initializes new projects with proper structure, dependencies, and configuration files.',
        },
        {
          name: 'docker-setup',
          ...
          type: 'command',
          content:
            'Creates Docker configurations including Dockerfile, docker-compose, and container optimization.',
        },
        {
          name: 'test-runner',
          ...
          category: 'testing',
          type: 'command',
          content: 'Sets up comprehensive testing frameworks and runs automated test suites.',
        },
        {
          name: 'build-pipeline',
          ...
          category: 'devops',
          type: 'command',
          content: 'Configures CI/CD pipelines for automated building, testing, and deployment.',
        },
      ],
      mcps: [
        {
          ...
          category: 'database',
          type: 'mcp',
          content: 'Connects to various databases and provides query and management capabilities.',
        },
        {
          name: 'api-client',
          path: 'api/api-client',
          category: 'api',
          type: 'mcp',
          content: 'HTTP client for interacting with REST APIs and web services.',
        },
        {
          name: 'file-manager',
          ...
          category: 'system',
          type: 'mcp',
          content: 'File system operations including reading, writing, and organizing files.',
        },
        {
          name: 'redis-cache',
          ...
          category: 'database',
          type: 'mcp',
          content: 'Redis caching implementation for improved application performance.',
        },
        {
          name: 'email-service',
          ...
          type: 'mcp',
          content: 'Email sending and management service with template support.',
        },
      ],
    };
  }
    ...
    if (tags.length > 0 || companies.length > 0 || technologies.length > 0) {
      filteredComponents = filteredComponents.filter((component) => {
        ...
        const hasMatchingTag =
          tags.length === 0 || tags.some((tag) => componentMeta.tags.includes(tag));

        const hasMatchingCompany =
          companies.length === 0 ||
          companies.some((company) => componentMeta.companies.includes(company));

        const hasMatchingTechnology =
          technologies.length === 0 ||
          technologies.some((tech) => componentMeta.technologies.includes(tech));
